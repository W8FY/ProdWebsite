...
!function(t,e,o,a,n){"use strict";t.fn.lightbox=function(n,s){if(typeof n===UNDEF)return this;s=t.extend({},t.fn.lightbox.defaults,s);var i,l,r,d,c,h,u,p,m,f,g,b,T,v,w,C,S,x,y,P,k,O,A=t(this),I=getTranslations(t.fn.lightbox.text),L=t([]),M=t(),E=t(),D=t(),F=t(),B=t(),N=!0,V=!1,H=!1,U=!1,R=!1,z=!1,X=!1,G=!1,W=!1,Z=!1,q=null,_=null,K=null,Q=null,j=-1,Y=0,$=0,tt=s.fitPadding,et=A.data("llb_ns"),ot=!!s.hasOwnProperty("extraSizes")&&s.extraSizes.split(/,\s*/),at=t("[data-audioplayer]"),nt=at.length&&!at.data("paused"),st=function(e){if(q=clearTimeout(q),K=clearTimeout(K),E&&E.length){var o,a,n,i,l,r,h,u,p,f=c.width(),g=c.height(),b=!1,T=D[0],v=D.hasClass("default");if(typeof d===UNDEF&&(d=parseInt(E.css("paddingTop"))),typeof tt===UNDEF&&(tt=Math.round((1-s.fitRatio)*Math.min(f,g)/2)),!(o=E.data("oWidth"))||!(a=E.data("oHeight")))if(N||H)o=typeof T.naturalWidth===UNDEF?T.width||D.width():T.naturalWidth,a=typeof T.naturalHeight===UNDEF?T.height||D.height():T.naturalHeight;else if(V)o=T.videoWidth,a=T.videoHeight;else if(R||z||X)o=f-2*d,a=g-2*d;else{var w=L.eq(j).data(J.OBJ);o=Math.max(240,w[J.IMAGE][J.WIDTH]),a=w[J.IMAGE][J.HEIGHT]}0!==o&&0!==a&&0!==f&&0!==g?(E.data({oWidth:o,oHeight:a}),f-=2*(tt+d),g-=2*(tt+d),n=0,s.fitImages&&s.fitBetween&&(c.hasClass(s.captionVisibleClass)&&B&&B.length&&(g-=Math.ceil(B.outerHeight())),s.thumbsVisible&&L.length>1&&m&&m.length&&(g-=Math.ceil(n=m.outerHeight()))),R||z||X?(o=Math.min(f,o),a=Math.min(g,a),i=1,u=p=!1):H&&v?(o=Math.min(s.defaultPosterSize[0],f),a=Math.min(s.defaultPosterSize[1],g),i=1,u=p=!1):(r=Math.min(f/o,s.maxZoom),h=Math.min(g/a,s.maxZoom),s.fitImages?(i=s.fitBoth?Math.min(r,h):h,i=s.scaleUp?Math.min(s.maxZoom,i):Math.min(1,i),b=N&&(s.autoPano&&!s.fitBoth&&o*i>=f*s.panoramaAutoDetect||G&&o*i>f),o=Math.round(o*i),a=Math.round(a*i),u=!b&&i<1||b&&!s.fitBoth):(i=1,o>f||a>g?(l=Math.max(r,h),(b=N&&(G&&(o*l>f||a*l>g)||s.autoPano&&(o/a>2||o/a<.5625)&&(o*l/f>=s.panoramaAutoDetect||a*l/g>=s.panoramaAutoDetect)))?(s.fitBoth&&(i=o>a?h:r,o=Math.round(o*i),a=Math.round(a*i)),u=!1):u=s.scaleUp&&i<1):u=s.scaleUp&&o<f&&a<g,HIDPI&&i<=1&&!s.scaleUp&&(o=Math.round(o/2),a=Math.round(a/2),i*=2)),p=i>=1||o>f||a>g),!0===e?E.css({left:tt+Math.round((f-o)/2),top:tt+Math.round(n+(g-a)/2),width:o+2*d,height:a+2*d,opacity:0}).show():E.stop(!0,!1).animate({left:tt+Math.round((f-o)/2),top:tt+Math.round(n+(g-a)/2),width:o+2*d,height:a+2*d},500,function(){b||t(this).translateX(0,500)}),N&&(b?Q=setTimeout(function(){b?E.autopano({direction:$}):E.trigger("autopanoRemove")},550):(Q=clearTimeout(Q),E.trigger("autopanoRemove"))),c.toggleClass("can-zoom-in",u),c.toggleClass("can-zoom-out",!u&&p)):q=setTimeout(st,100,!0)}},it=function(){if(!(--Y>0)){if(DEBUG){var e=new Date;R||z?console.log((R?"External content":"360 player")+" loaded: "+(e-r)+"ms"):D.length&&(console.log((V||H?"Media":"Image")+" ["+j+"] loaded: "+(e-r)+'ms src="'+D[0].src+'"'),typeof D[0]!==UNDEF&&typeof F[0]!==UNDEF||console.log((D[0],UNDEF,"loadImage.done("+D[0].src+")")))}switch(E.hide().css("opacity",0),s.transitionType){case"crossFadeAndSlide":E.translateXAndFade(100*$,0);break;case"crossFadeAndZoom":E.transform({scale:1-$/40,opacity:0})}(N||V||H)&&s.rightClickProtect&&F.on("contextmenu",function(t){return t.preventDefault(),!1}),(V||H)&&(F.attr({autoplay:s.videoAuto,loop:s.videoLoop}),F[0].volume=s.volume,F.on("volumechange."+et,function(){s.volume=this.volume})),setTimeout(function(){switch(st(!0),u.hide(),E.show(),s.transitionType){case"crossFadeAndSlide":E.translateXAndFade(0,1,s.speed);break;case"crossFadeAndZoom":E.transform({scale:[1,1],opacity:1},s.speed);break;default:E.opacity(1,s.speed)}setTimeout(function(){z||X||R&&E.children("iframe").length||E.swipe({onSwipeStart:function(){t(this).trigger("autopanoStop")},onSwipedLeft:function(){W=!0,kt()},onSwipedRight:function(){W=!0,Pt()},onFinished:function(){Z||(t(this).trigger("removeSwipe"),t(this).remove())},onClick:function(e){c.data("panomove")?t(this).trigger("autopanoStop"):function(e){var o="touch"===t("html").data("whatinput")||"touchend"===e.type;if(V||H){var a=F[0];a.paused?(a.play(),"ms"!==VEND&&(a.controls=!1),o&&(xt(),c.hasClass(s.captionVisibleClass)&&wt())):(a.pause(),"ms"!==VEND&&(a.controls=!0),o&&(Ct(),vt()))}else N&&(o?(xt(),c.hasClass(s.captionVisibleClass)||vt()):s.clickForNext&&((e.pageX||e.originalEvent.pageX)-E.position().left>E.width()/2?kt():Pt()))}(e)}}),!1!==s.onLoadEnd&&s.onLoadEnd(M),s.preloadNext&&function(){var t;$<0&&j>0?t=L.eq(j-1).data(J.OBJ):j<L.length-2&&(t=L.eq(j+1).data(J.OBJ)),t&&"image"===t[J.CATEGORY]&&((new Image).src=n.getImagePath(t))}()},s.speed/2)},50),l?H||V?(ut(),F[0].onended=function(){ct()}):(clearTimeout(l),k&&k.find(".progress").show(),l=setTimeout(kt,s.slideshowDelay)):(ht(!0),s.autohideControls&&yt())}},lt=function(o){if("number"!=typeof o&&(o=L.index(o)),o<0||o>=L.length){if(Z=!0,o<0)switch(s.afterLast){case"donothing":o=0;break;case"startover":o=L.length-1;break;case"onelevelup":s.level&&(window.location.href="../"+s.indexName),o=0;break;case"nextfolder":s.baseSet&&s.previousFoldersLast&&(window.location.href=s.previousFoldersLast),o=0;break;default:o=0,rt()}else switch(s.afterLast){case"donothing":o=L.length-1;break;case"startover":o=0;break;case"onelevelup":s.level&&(window.location.href="../"+s.indexName),o=L.length-1;break;case"nextfolder":s.baseSet&&s.nextFoldersFirst&&(window.location.href=s.nextFoldersFirst),o=L.length-1;break;case"ask":var d=new Array;return W&&(E.translateXAndFade(0,1,2*s.speed),W=!1),o=L.length-1,L.length>1&&d.push({t:I.startOver,c:"icon-loop",h:function(t){lt(0)}}),s.level&&d.push({t:s.level?I.upOneLevel:s.homepageLinkText||I.backToHome,c:"icon-up-one-level",h:function(){window.location.href="../"+s.indexName}}),d.push({t:I.backToIndex,c:"icon-index",h:function(){rt()}}),s.baseSet&&s.nextFoldersFirst&&d.push({t:I.nextFolder,c:"icon-arrow-right",h:function(){window.location.href=s.nextFoldersFirst}}),void c.modal(t("<p>",{class:"text-center",text:I.atLastPageQuestion}),d,{onClose:function(){lt(L.length-1)},class:"secondary",title:I.atLastPage});default:o=L.length-1,rt()}W&&(E.translateXAndFade(0,1,2*s.speed),W=!1)}else Z=!1;if(c.is(":visible")){if($=j>o?-1:j<o?1:0,j===o)return}else a.css("overflow","hidden"),$=0,s.useFullScreen&&t("html").fullScreen(!0),c.show(),nt=at.length&&!at.data("paused"),s.autoStart&&dt(),At(It);c.find(".modal").trigger("destroy");var h;j=o,M=L.eq(j),h=M.data(J.OBJ),s.useThumbstrip&&L.length>1&&Ot(),h?(u.show(),k&&k.find(".progress").hide(),function(t){if(V=H=U=N=z=X=!1,R=t.hasOwnProperty(J.EXTERNAL),z=!R&&s.use360Player&&t.hasOwnProperty(J.PROJECTIONTYPE),!R&&!z)switch(t[J.CATEGORY]){case"video":V=!0;break;case"audio":H=!0;break;case"other":U=!0,X="pdf"===n.getExtension(t).toLowerCase();break;default:N=!0}}(h),G=h.hasOwnProperty(J.PANORAMA),!1!==s.onLoadStart&&s.onLoadStart(M),setTimeout(function(){if(function(){var t=c.find(".lightbox-main"),e=c.find(".lightbox-caption");if(t.length&&(t.trigger("autopanoRemove").off("."+et),s.muteBackgroundAudio&&nt&&(H||V?at.trigger("fadeOutPlayer"):at.trigger("fadeInPlayer")),!W))switch(s.transitionType){case"crossFadeAndSlide":t.translateXAndFade(-100*$,0,s.speed,function(){t.remove()});break;case"crossFadeAndZoom":t.transform({scale:1+$/40,opacity:0},s.speed,function(){t.remove()});break;default:t.opacity(0,s.speed,function(){t.remove()})}e.length&&(e.find(".buttons a").trigger("removeTooltip"),e.length>1&&(e.eq(-1).prevAll(".lightbox-caption").remove(),e=c.find(".lightbox-caption")),e.opacity(0,s.speed,function(){e.remove()}))}(),W=!1,Y=1,r=new Date,E=t("<div>",{class:"lightbox-main "+(R?"external":z?"vr":X?"pdf":h[J.CATEGORY])}).hide().appendTo(c),N)F=D=t("<img>").one("load."+et,function(t){it()}).attr("src",n.getImagePath(h)).appendTo(E),DEBUG&&console.log("Loading image ["+j+'] src="'+n.getImagePath(h)+'"'),D[0].complete&&D[0].naturalWidth>0&&(D.off("load."+et),it());else if(H||V){if(V)F=D=t("<video>",{preload:"auto",controls:"controls",controlsList:"nodownload",poster:n.getPosterPath(h)});else{var o=n.getPosterPath(h);Y=2,D=t("<img>",{class:"poster"+(o.endsWith("poster.png")?" default":"")}).one("load",function(t){it()}).attr("src",o).appendTo(E),F=t("<audio>",{preload:"auto",controls:"true",controlsList:"nofullscreen nodownload"})}F.one("loadedmetadata",function(t){it()}).attr("src",n.getSourcePath(h)).appendTo(E),s.muteBackgroundAudio&&at.length&&(F.on("playing",pt).on("paused",mt).on("ended",ft),nt=!at.data("paused"))}else if(R){var a=h[J.EXTERNAL].cont,d=h[J.EXTERNAL].size;d&&(d=d.split("x"),E.data({oWidth:parseInt(d[0]),oHeight:parseInt(d[1])})),E.one("DOMReady",function(t){it()}),a.match(/^https?\:\/\//i)||a.match(/\.html?$/i)||a.match(/^\.\.\//)?E.addClass("iframe").append(t("<iframe>",{width:"100%",height:"100%",src:a,frameborder:0,allowfullscreen:"allowfullscreen"})):(a.match(/^<iframe/i)&&E.addClass("iframe"),E.append(a)),setTimeout(it,200)}else if(z){var u=Math.round(c.width()*s.fitRatio),p=Math.round(c.height()*s.fitRatio);E.css({width:u,height:p}).attr("id","vr"+j).addClass("vr").show().one("DOMReady",it),setTimeout(function(){new PhotoSphereViewer({panorama:n.getAbsoluteImagePath(h),container:E[0],usexmpdata:!1,zoom_level:30,loading_html:'<div class="lightbox-loading"><div></div></div>',navbar:!0,navbar_style:{autorotateThickness:2,zoomRangeThickness:2,zoomRangeDisk:12,fullscreenThickness:2,backgroundColor:"rgba(17, 17, 17, 0.35)"}})},s.speed),setTimeout(it,200)}else{var m=E;X&&(m=!HASPDFVIEWER||ISIOSDEVICE?t("<iframe>",{src:"https://docs.google.com/viewer?url="+window.location.href.getDir()+n.getSourcePath(h)+"&embedded=true"}).appendTo(E):t("<object>",{type:"application/pdf"}).attr("data",n.getSourcePath(h)).appendTo(E)),t("<a>",{href:n.getSourcePath(h),target:"_blank"}).append(t("<img>",{class:"other"}).one("load",function(t){it()}).attr("src",n.getImagePath(h))).appendTo(m),t("<p>",{class:"click-hint",html:I.clickToOpen}).appendTo(m)}!function(o){B=t("<div>",{class:"lightbox-caption"+(l?" slideshow":"")}).hide().appendTo(c);var a=t("<div>",{class:"buttons"}),r=s.buttonLabels&&c.width()>=640;if(ot&&"image"===o[J.CATEGORY]){i=t("<div>",{class:"download icon-download"}).appendTo(a);for(var d=n.getImagePath(o),h=0;h<ot.length;h++)i.append(t("<a>",{text:ot[h],href:d.replace("slides/","dl/"+ot[h]+"/"),download:""}))}if(s.printImage&&"image"===o[J.CATEGORY]&&!s.rightClickProtect&&(i=t("<a>",{class:s.buttonClass+" icon-printer"}).appendTo(a),r?i.html("<span>"+I.print+"</span>").data("tooltip",I.printLabel):i.data("tooltip",I.print),i.on("click",function(t){printImage(o[J.ORIGINAL]&&!s.hideDownload?o[J.ORIGINAL][J.PATH]:o[J.IMAGE][J.PATH],o[J.TITLE]||"",o[J.THUMBCAPTION]||"")})),o[J.ORIGINAL]&&!s.hideDownload&&(N||X||s.allowDownloadOthers)&&(i=t("<a>",{class:s.buttonClass+" icon-download",download:"",href:n.getOriginalPath(o)}).appendTo(a),r?i.html("<span>"+I.download+"</span>"):i.data("tooltip",I.download)),s.hasOwnProperty("shop")&&n.hasShop(o)){var u=n.getPriceRange(o);u=I.addCart+(u?" <b>"+u+"</b>":""),i=t("<a>",{class:s.buttonClass+" icon-shopping-cart"}).on("click",function(t){s.shop.root.trigger("addItems",o)}).appendTo(a),r?i.html("<span>"+u+"</span>").data("tooltip",I.shopLabel):i.data("tooltip",u),i=t("<a>",{class:s.buttonClass+" secondary icon-shopping-cart"}).on("click",function(t){s.shop.root.trigger("showCart")}).appendTo(a),r?i.html("<span>"+I.viewCart+"</span>").data("tooltip",I.viewCartLabel):i.data("tooltip",I.viewCart)}s.hasOwnProperty("feedback")&&(i=t("<a>",{class:s.buttonClass+" icon-email"}).on("click",function(t){s.feedback.root.trigger("addItems",o)}).appendTo(a),r?i.html("<span>"+I.addComment+"</span>").data("tooltip",I.feedbackLabel):i.data("tooltip",I.addComment)),!LOCAL&&typeof FOTOMOTO!==UNDEF&&s.fotomoto&&(i=t("<a>",{class:s.buttonClass+" icon-fotomoto"}).on("click",function(t){FOTOMOTO.API.showWindow(10,n.getOriginalPath(o)||n.getItemPath(o))}).appendTo(a),r?i.html("<span>"+I.fotomotoBtn+"</span>").data("tooltip",I.fotomotoTooltip):i.data("tooltip",I.fotomotoBtn)),o[J.PHOTODATA]&&s.metaAsPopup&&(i=t("<a>",{class:s.buttonClass+" icon-camera"}).appendTo(a),r?i.html("<span>"+I.metaBtn+"</span>").data("tooltip",I.metaLabel):i.data("tooltip",I.metaBtn),i.on("click",function(){return c.modal(t("<div>",{class:"photodata",html:o[J.PHOTODATA]}),{class:"small",title:I.metaBtn}),!1})),s.showRegions&&o[J.REGIONS]&&(i=t("<a>",{class:s.buttonClass+" icon-user"}).appendTo(a),r?i.html("<span>"+(s.regionsBtn||I.regionsBtn)+"</span>").data("tooltip",I.regionsLabel):i.data("tooltip",s.regionsBtn||I.regionsBtn),i.on("click",function(){var e=c.find("."+s.regionsClass);if(e.length)e.remove();else{var a=JSON.parse(o[J.REGIONS]);e=t("<div>",{class:s.regionsClass}).appendTo(E);for(var n,i=0;i<a.length;i++)n=a[i].split(";"),e.append(t("<a>").css({left:100*parseFloat(n[1])+"%",top:100*parseFloat(n[2])+"%",width:100*parseFloat(n[3])+"%",height:100*parseFloat(n[4])+"%"}).append("<span>"+n[0]+"</span>"))}return!1})),!LOCAL&&s.showMap&&o[J.LOCATION]&&(i=t("<a>",{class:s.buttonClass+" icon-location"}).appendTo(a),r?i.html("<span>"+I.mapBtn+"</span>").data("tooltip",I.mapLabel):i.data("tooltip",I.mapBtn),i.on("click",function(){var a=t("<div>",{class:"map-cont"});return a.height(e.height()*s.mapHeight),c.modal(a,{class:"no-padding"}),setTimeout(function(){a.addMap({location:o[J.LOCATION],type:s.mapType,zoom:s.mapZoom,fitBounds:!1,fullscreenControl:!1,onTypeChanged:function(t){s.mapType=t},onZoomChanged:function(t){s.mapZoom=t}})},100),!1})),!LOCAL&&o[J.MOSTPHOTOS]&&(i=t("<a>",{class:s.buttonClass+" icon-shopping-cart",target:"_blank",href:"https://mostphotos.com/"+o[J.MOSTPHOTOS]}).appendTo(a),r?i.html("<span>"+I.mostphotosBtn+"</span>").data("tooltip",I.mostphotosLabel):i.data("tooltip",I.mostphotosBtn)),s.share&&s.showShare&&(i=t("<a>",{class:s.buttonClass+" icon-connect"}).appendTo(a),r?i.text(" "+I.share).data("tooltip",I.shareLabel):i.data("tooltip",I.share),i.on("click",function(){var e=t("<div>",{class:"share-cont social-links text-center"});return c.modal(e,{class:"small",title:I.shareOn}),setTimeout(function(){e.renderShares({sites:s.share,title:o[J.TITLE]||o[J.NAME],description:o[J.COMMENT],image:n.getAbsoluteImagePath(o),href:n.getAbsolutePath(o)})},100),!1})),s.showNumbers&&a.prepend(t("<h4>",{class:"numbers",html:"<span>"+(j+1)+"</span> / "+L.length})),o[J.SOUNDCLIP]&&a.append(t("<audio>",{class:"soundclip",src:o[J.SOUNDCLIP],controls:"controls"})),a.is(":empty")||(B.addClass(s.hasbuttonsClass),B.append(a),a.children("a").addTooltip()),o[J.IMAGECAPTION]&&(B.append(t("<div>",{class:"caption",html:o[J.IMAGECAPTION]})),B.find("[data-tooltip]").addTooltip()),o[J.PHOTODATA]&&!s.metaAsPopup&&B.append(t("<div>",{class:"photodata",html:o[J.PHOTODATA]})),B.is(":empty")?(B.remove(),c.removeClass(s.captionVisibleClass),c.addClass("no-caption")):(c.toggleClass(s.captionVisibleClass,s.captionVisible),c.removeClass("no-caption"),B.show())}(h)},s.speed/4)):console.log("Fatal error: image ("+j+") is missing from the database! (Upload data1.json again!)")},rt=function(){if(ht(!0),a.css("overflow",""),s.muteBackgroundAudio&&nt&&at.trigger("fadeInPlayer"),E.length){if((H||V)&&F){var e=F[0].volume,o=s.speed/(50*e),n=function(){if(F){var t=Math.max(F[0].volume-.02,0);t>.005?(F[0].volume=t,setTimeout(n,o)):F[0].pause()}};F.off("."+et),n()}c.fadeOut(s.speed,function(){s.useFullScreen&&t("html").fullScreen(!1),E.length&&(E.remove(),E=t()),B.length&&(B.remove(),B=t()),!1!==s.onClose&&s.onClose(M)})}else!1!==s.onClose&&s.onClose(M)},dt=function(t){l=clearTimeout(l),P&&(P.hide(),k.show()),c.addClass(s.playingClass),s.autohideControls&&yt(),B.addClass("slideshow"),l=setTimeout(kt,s.slideshowDelay/4),!0!==t&&s.backgroundAudioSlideshowControl&&at.trigger("fadeInPlayer"),!1!==s.onSlideshowStart&&s.onSlideshowStart(M)},ct=function(){s.autohideControls&&yt(),c.addClass(s.playingClass),l=setTimeout(kt,s.slideshowDelay/4),s.backgroundAudioSlideshowControl&&at.trigger("fadeInPlayer")},ht=function(t){!1!==s.onSlideshowPause&&s.onSlideshowPause(M),!0!==t&&s.backgroundAudioSlideshowControl&&at.trigger("fadeOutPlayer"),P&&(P.show(),k.hide()),l=clearTimeout(l),B.show().removeClass("slideshow"),c.removeClass(s.playingClass),_=clearTimeout(_)},ut=function(){s.backgroundAudioSlideshowControl&&at.trigger("fadeOutPlayer"),l=clearTimeout(l),Ct()},pt=function(){s.muteBackgroundAudio&&(nt=!at.data("paused"))&&at.trigger("fadeOutPlayer")},mt=function(){s.muteBackgroundAudio&&nt&&at.trigger("fadeInPlayer")},ft=function(){nt=!1},gt=function(){s.fitImages=!s.fitImages,Jt(),st()},bt=function(){c.addClass(s.thumbsVisibleClass),s.thumbsVisible=!0,Jt(),st()},Tt=function(){c.removeClass(s.thumbsVisibleClass),s.thumbsVisible=!1,Jt(),st()},vt=function(){c.addClass(s.captionVisibleClass),s.captionVisible=!0,Jt(),st()},wt=function(){c.removeClass(s.captionVisibleClass),s.captionVisible=!1,Jt(),st()},Ct=function(){_=clearTimeout(_),c.removeClass(s.controlsHideClass)},St=function(){_=clearTimeout(_),g.hideAllTooltips(),c.addClass(s.controlsHideClass)},xt=function(){c.hasClass(s.controlsHideClass)?Ct():St()},yt=function(){clearTimeout(_),_=setTimeout(St,l?Math.min(s.slideshowDelay/2,1500):1500)},Pt=function(){lt(j-1)},kt=function(){lt(j+1)},Ot=function(){if(s.useThumbstrip&&!(L.length<2)){var t=f.children().eq(j<0?0:j),e=t.position().left,o=t.width(),a=f.translateX(),n=m.width(),i=f.width();f.children().removeClass(s.activeClass),t.addClass(s.activeClass),e<-a?f.translateX(Math.min(0,s.thumbOverhead-e),s.thumbSpeed,At):e+o>n-a?f.translateX(Math.max(n-e-o-s.thumbOverhead,n-i),s.thumbSpeed,At):n-a>i&&f.translateX(n-i,s.thumbSpeed,At)}},At=function(e){if(c.is(":visible")&&s.useThumbstrip&&!(L.length<2)){var o=m.width(),a=f.translateX()||0;f.children("."+s.lazyloadClass).each(function(){var e=t(this),n=e.position().left,i=e.width();if(n+a<o&&n+i+a>0)e.removeClass(s.lazyloadClass),function(e){if(e.length){var o=t("<img>",{class:"hide-image"}).one("load",function(){t(this).removeClass("hide-image").addClass("show-image")}).attr("src",e.attr("href"));s.rightClickProtect&&o.on("contextmenu",function(t){return t.preventDefault(),!1}),e.append(o).removeAttr("href")}}(e),e.addTooltip({delay:1e3});else if(n+a>=o)return!1}),"function"==typeof e&&e.call(this)}},It=function(){if(c.is(":visible")){var t=f.children(":last-child");t.position().left+t.outerWidth()>m.width()?(p.addClass(s.scrollClass),Ot()):(p.removeClass(s.scrollClass),f.translateX(0,s.thumbSpeed))}},Lt=function(t){var e=m.width(),o=f.translateX()||0;e>f.width()?o&&f.translateX(0,s.thumbSpeed,At):(o=t<0?Math.min(0,o+e):Math.max(e-f.width(),o-e),f.translateX(o,s.thumbSpeed,At))},Mt=function(){s.thumbsVisible&&c.addClass(s.thumbsVisibleClass),(p=t("<div>",{class:"thumb-strip"}).appendTo(c)).append(t("<button>",{class:"left icon-drop-left"}).on("click."+et,function(t){return Lt(-1),!1})),p.append(t("<button>",{class:"right icon-drop-right"}).on("click."+et,function(t){return Lt(1),!1})),(m=t("<div>",{class:"thumb-cont"}).appendTo(p)).on("selectstart."+et,function(t){return!1});var e,o,a,i=(f=t("<div>",{class:"thumbs"}).appendTo(m)).height()||60,l=0;L.each(function(r){e=t(this).data(J.OBJ),(a=t("<a>",{class:s.lazyloadClass,title:e[J.THUMBCAPTION]||"",href:n.getThumbPath(e)}).appendTo(f)).on("click",function(e){var o=t(e.target).closest("a");return lt(f.children().index(o)),!1}),o=(i-4)*e[J.THUMB][J.WIDTH]/e[J.THUMB][J.HEIGHT],a.width(o),l+=o})},Et=function(){g=t("<div>",{class:"controls"+(s.controlsUseText?" use-text":"")}).appendTo(c),L.length>1&&(b=t("<button>",{type:"button",class:"lightbox-btn previous icon-previous",title:I.previousPicture,text:s.controlsUseText?I.previousPictureShort:""}).on("click."+et,Pt).appendTo(g)),T=t("<button>",{type:"button",class:"lightbox-btn up icon-up-light",title:I.upOneLevel,text:s.controlsUseText?I.upOneLevelShort:""}).on("click."+et,rt).appendTo(g),s.useZoom&&(v=t("<button>",{type:"button",class:"lightbox-icon zoom-in icon-expand",title:I.oneToOneSize,text:s.controlsUseText?I.oneToOneSizeShort:""}).on("click."+et,gt).appendTo(g),w=t("<button>",{type:"button",class:"lightbox-icon zoom-out icon-contract",title:I.fitToScreen,text:s.controlsUseText?I.fitToScreenShort:""}).on("click."+et,gt).appendTo(g)),s.useThumbstrip&&L.length>1&&(C=t("<button>",{type:"button",class:"lightbox-icon show-thumbs icon-show-top-thumbs",title:I.showThumbs,text:s.controlsUseText?I.showThumbsShort:""}).on("click."+et,bt).appendTo(g),S=t("<button>",{type:"button",class:"lightbox-icon hide-thumbs icon-hide-top-thumbs",title:I.hideThumbs,text:s.controlsUseText?I.hideThumbsShort:""}).on("click."+et,Tt).appendTo(g)),x=t("<button>",{type:"button",class:"lightbox-icon show-caption icon-show-bottom-panel",title:I.showInfo,text:s.controlsUseText?I.showInfoShort:""}).on("click."+et,vt).appendTo(g),y=t("<button>",{type:"button",class:"lightbox-icon hide-caption icon-hide-bottom-panel",title:I.hideInfo,text:s.controlsUseText?I.hideInfoShort:""}).on("click."+et,wt).appendTo(g),s.useSlideshow&&L.length>1&&(P=t("<button>",{type:"button",class:"lightbox-icon play icon-slideshow",title:I.startSlideshow,text:s.controlsUseText?I.startSlideshowShort:""}).on("click."+et,dt).appendTo(g),k=t("<button>",{type:"button",class:"lightbox-icon pause icon-pause",title:I.pause,text:s.controlsUseText?I.pauseShort:""}).append(t("<span>",{class:"progress"})).on("click."+et,ht).appendTo(g)),L.length>1&&(O=t("<button>",{type:"button",class:"lightbox-btn next icon-next",title:I.nextPicture,text:s.controlsUseText?I.nextPictureShort:""}).on("click."+et,kt).appendTo(g)),g.children("button").addTooltip({delay:1e3})},Jt=function(){var e,o,a={};for(e in s.prefsKept)o=s.prefsKept[e],s.hasOwnProperty(o)&&(a[o]=s[o]);a&&t.cookie("lb_pref",a)};if(et&&function(o){e.add(document).off("."+o),t("#"+o).remove()}(et),A.data("llb_ns",et="llb_"+Math.floor(1e4*Math.random())),L=A.find(s.delegate),function(){var e,o,a=t.cookie("lb_pref");if(a)for(e in s.prefsKept)o=s.prefsKept[e],a.hasOwnProperty(o)&&(s[o]="true"===a[o]||"false"===a[o]?!!a[o]:a[o])}(),function(e){c=t("<div>",{id:e,class:"lightbox"}).hide().appendTo("body"),h=t("<div>",{class:"lightbox-overlay"}).appendTo(c),u=t("<div>",{class:"lightbox-loading"}).append("<div>").appendTo(c),c.toggleClass(s.thumbsVisibleClass,s.thumbsVisible&&L.length>1),c.toggleClass(s.captionVisibleClass,s.captionVisible),c.toggleClass("zoomed",s.fitImages),Et(),s.useThumbstrip&&L.length>1&&Mt()}(),"touch"!==t("html").data("whatinput")&&c.on("mousemove."+et,function(){c.hasClass(s.controlsHideClass)&&Ct(),s.autohideControls&&yt()}),e.on("resize."+et,function(){clearTimeout(K),K=setTimeout(function(){clearTimeout(K),!E||!E.length||z&&(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement||document.msFullscreenElement)||st(),At(It)},50)}),s.quitOnDocClick&&h.on("click."+et,function(e){E.length&&!t(e.target).is(E)&&rt()}),s.enableKeyboard&&o.on("keyup."+et,function(t){if(!E.length||c.children(".modal:visible").length||document.activeElement&&("INPUT"===document.activeElement.nodeName||"TEXTAREA"===document.activeElement.nodeName))return!0;switch(t.preventDefault(),t.keyCode){case 27:rt();break;case 33:case 37:Pt();break;case 34:case 39:kt();break;case 97:case 35:lt(L.length-1);break;case 103:case 36:lt(0);break;case 106:case 179:l?ht():dt();break;case 107:gt();break;case 109:s.captionVisible||s.thumbsVisible?s.thumbsVisible=s.captionVisible=!1:(c.addClass(s.thumbsVisibleClass).addClass(s.captionVisibleClass),s.thumbsVisible=s.captionVisible=!0),Jt(),st();break;case 32:V||H?F[0].paused?F[0].play():F[0].pause():l?ht():dt();break;default:return!0}return!1}),s.enableMouseWheel){var Dt=null;c.on("mousewheel."+et+" DOMMouseScroll."+et,function(t){return Dt=clearTimeout(Dt),!(E.length&&!E.hasClass("pdf")&&!c.children(".modal:visible").length)||(Dt=setTimeout(t.originalEvent.wheelDelta>0||t.originalEvent.detail<0?Pt:kt,100),!1)})}return A.on("lightboxLoad."+et,function(t,e,o){ht(!0),e="number"==typeof e?Math.minMax(0,e,L.length):typeof e===UNDEF?0:L.index(e),!1!==s.onStart&&s.onStart("number"==typeof e?L.eq(e):th),lt(e),o&&("number"==typeof o?setTimeout(dt,o):dt())}).on("lightboxQuit."+et,function(){return rt(),!1}).on("lightboxRemove."+et,function(){return ht(!0),L.off("."+et),o.add(e).add(c).off("."+et),a.css("overflow",""),E.length?E.animate({opacity:0},s.speed,function(){c.remove()}):c.remove(),!1}).on("lightboxContainer."+et,function(){return c}).on("lightboxNext."+et,function(){return ht(),kt(),!1}).on("lightboxPrevious."+et,function(){return ht(),Pt(),!1}),s.hasOwnProperty("onReady")&&t.isFunction(s.onReady)&&s.onReady(M),s.autoStart&&s.baseSet&&dt(),this},t.fn.lightbox.defaults={delegate:".card.lbable",buttonClass:"button small",lazyloadClass:"lazyload",activeClass:"active",scrollClass:"scroll",regionsClass:"regions",captionVisibleClass:"caption-visible",thumbsVisibleClass:"thumbs-visible",hasbuttonsClass:"hasbuttons",controlsVisibleClass:"controls-visible",controlsHideClass:"controls-hide",playingClass:"playing",slideshowDelay:4e3,prefsKept:["thumbsVisible","captionVisible","fitImages"],controlsUseText:!1,thumbsVisible:!0,useThumbstrip:!0,captionVisible:!0,fitImages:!0,fitBoth:!0,fitBetween:!0,fitRatio:.94,maxZoom:1.4,scaleUp:!1,useZoom:!0,indexName:"index.html",baseSet:!0,autohideControls:!0,autoStart:!1,clickForNext:!0,useSlideshow:!0,backgroundAudioSlideshowControl:!1,muteBackgroundAudio:!0,use360Player:!0,useFullScreen:!1,afterLast:"donothing",mapHeight:.8,showShopBtn:!0,showLowestPrice:!1,videoAuto:!1,videoLoop:!1,autoPano:!1,volume:.5,rightClickProtect:!1,buttonLabels:!0,showNumbers:!1,showShare:!1,allowDownloadOthers:!1,hideDownload:!1,showMap:!1,showRegions:!0,printImage:!1,metaAsPopup:!0,transitionType:"crossFadeAndSlide",speed:400,panoramaAutoDetect:1.5,panoramaTreshold:[2.5,2.5],defaultPosterSize:[628,360],thumbSpeed:400,thumbOverhead:40,preloadNext:!0,enableKeyboard:!0,enableMouseWheel:!0,quitOnEnd:!0,quitOnDocClick:!0,onStart:!1,onClose:!1,onLoadStart:!1,onLoadEnd:!1,onReady:!1,onSlideshowStart:!1,onSlideshowPause:!1},t.fn.lightbox.text={startOver:"Start over",upOneLevel:"Up one level",upOneLevelShort:"Exit",backToHome:"Back to home",backToIndex:"Back to index page",nextFolder:"Next folder",atLastPageQuestion:"Where to go next?",atLastPage:"At last page",atFirstPage:"At first page",previousPicture:"Previous image",previousPictureShort:"Prev",nextPicture:"Next image",nextPictureShort:"Next",oneToOneSize:"1:1 size",oneToOneSizeShort:"1:1",fitToScreen:"Fit to screen",fitToScreenShort:"Fit",showThumbs:"Show thumbnail strip",showThumbsShort:"Thumbnails",hideThumbs:"Hide thumbnail strip",hideThumbsShort:"Hide thumbs",showInfo:"Show caption / info",showInfoShort:"Info",hideInfo:"Hide caption / info",hideInfoShort:"Hide info",startSlideshow:"Start slideshow",startSlideshowShort:"Play",pause:"Pause",pauseShort:"Pause",download:"Download",print:"Print",printLabel:"Print out this photo on your printer",mapBtn:"Map",mapLabel:"Show the photo location on map",fotomotoBtn:"Buy / Share",fotomotoLabel:"Buy prints or digital files, share, send free eCards",mostphotosBtn:"Purchase",mostphotosLabel:"Download this image from <b>mostphotos.com</b>!",regionsBtn:"People",regionsLabel:"Show tagged people",share:"Share",shareLabel:"Share this photo over social sites",shareOn:"Share on",shopBtn:"Buy",shopLabel:"Add this item to the shopping cart",viewCartLabel:"View shopping cart",feedbackLabel:"View feedback window",metaBtn:"Photo data",metaLabel:"Display photographic (Exif/Iptc) data",viewCart:"View cart",addCart:"Add to cart",addComment:"Add comment",clickToOpen:"Click to open this document with the associated viewer!"}}(jQuery,jQuery(window),jQuery(document),jQuery("body"));
